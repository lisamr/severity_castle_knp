...
# extract mean of chosen raster in each ring
means <- terra::extract(r_brick[dist_dep_var], vect(rings), fun = mean, 
                             weights = T, na.rm = T) %>% pull(dist_dep_var)
